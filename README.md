...
**Mini hot-swappable mechanical keyboard with 12 Cherry MX compatible switches, translucent key caps, USB-C, RP2040 microcontroller, mini OLED display, backlighting and under lighting.**

ANAVI Macro Pad 12 is an open source, custom-programmable, mini mechanical keyboard/keypad.
